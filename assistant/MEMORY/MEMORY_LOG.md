...
| 升 episodic_memory | `00.memory_agent.md §L0→L1 升格抽象红线 / §episodic_memory 规则` |
| 升 semantic | `00.memory_agent.md §升格判准 / §横向统合` |
| 升星 / 衰减 | `00.memory_agent.md §升星 / §episodic 衰减 / §semantic 衰减` |
...
> v5 毕业条件：semantic 候选条目达 6 星 + 跨周稳定 ≥ 3 周 + 用户 C verdict 后，完整审计落点。
